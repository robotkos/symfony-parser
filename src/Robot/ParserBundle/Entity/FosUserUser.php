...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \Robot\ParserBundle\Entity\FosUserGroup $group
     * @return FosUserUser
     */
    public function addGroup(\Robot\ParserBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Robot\ParserBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\Robot\ParserBundle\Entity\FosUserGroup $group)
    {
